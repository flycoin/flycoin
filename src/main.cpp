...
{
    int64 nSubsidy = 380 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 22800; // FlyCoin: 380 minutes
static const int64 nTargetSpacing = 30; // FlyCoin: 30 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal flycoin miner
